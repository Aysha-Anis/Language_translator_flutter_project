...
class LanguageTranslationClass extends StatefulWidget {
  const LanguageTranslationClass({super.key});

  @override
  State<LanguageTranslationClass> createState() => _LanguageTranslationClassState();
}

class _LanguageTranslationClassState extends State<LanguageTranslationClass> {
